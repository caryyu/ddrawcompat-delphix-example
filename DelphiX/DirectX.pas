...
const
  NilGUID : TGUID = (D1: 0; D2: 0; D3: 0; D4: (0, 0, 0, 0, 0, 0, 0, 0));
...
// Delphi 2007 rejects managed interface types inside variant records.
  // Keep the old DelphiX workaround enabled for all modern Delphi compilers.
