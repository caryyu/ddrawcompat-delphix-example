 ...
 * KNOWN BUGS:
   1/ On some adapteurs no good shows transparent area when DIRECTDRAWSURFACE is
      called in 16 bit color deepth and windowed mode.
 ...
 *  e-mail: delphix_d2d@micrel.cz
  ...
  private
    ...
    function D2DTexturedOn(Image:TPictureCollectionItem; Pattern: Integer): Boolean; overload;
    function D2DTexturedOn(dds:TDirectDrawSurface; Transparent: Boolean): Boolean; overload;
    ...
    procedure D2DEffectAdd(Alpha: Byte); overload;
    procedure D2DEffectAdd(L1, L2, L3, L4: Integer); overload;
    procedure D2DEffectBlend(Alpha: Byte); overload;
    Procedure D2DEffectBlend(L1, L2, L3, L4: Integer); overload;
    procedure D2DEffectMul(L1, L2, L3, L4: Integer); overload;
    Procedure D2DEffectMul(Alpha: Byte); overload;
    procedure D2DEffectNone;
    procedure D2DEffectCol(L1, L2, L3, L4: Integer);
    procedure D2DEffectAddCol(C1, C2, C3, C4: Integer);
    procedure D2DEffectSolid; overload;
    procedure D2DEffectSolid(Color: Integer); overload;
    procedure D2DEffectSub(Alpha: Byte);
    procedure D2DMeshMapToRotate(X, Y, W, H: Integer; Px, Py: Double; Angle: Byte);
    procedure D2DMeshMapToRect(R: TRect);
    procedure SizeAdjust(var DIB: TDIB; var FloatX1, FloatY1, FloatX2,
      FloatY2: Double);
    function  D2DMeshMapToWave(dds:TDirectDrawSurface; Transparent:Boolean; X, Y, Width, Height, amp, Len,
      ph, Alpha: Integer; Effect:Byte):Boolean;
    procedure D2DPruneTextures;
    function D2DTexturedOnRect(Rect: TRect; Color: Integer): Boolean;
  public
    {destruct textures here}
    destructor Destroy; override;
    ...
    {Render routines}
    function D2DRenderAlpha(Source: TDirectDrawSurface; R: TRect; Transparent: Boolean; Pattern: Integer; Alpha: Byte): boolean; overload;
    function D2DRenderAlpha(Image: TPictureCollectionItem; R: TRect; Pattern: Integer; Alpha: Byte): boolean; overload;
    function D2DRenderSub(Source: TDirectDrawSurface; R: TRect;Transparent: Boolean; Pattern: Integer; Alpha: Byte): boolean; overload;
    function D2DRenderSub(Image: TPictureCollectionItem; R: TRect;Pattern: Integer; Alpha: Byte): boolean; overload;
    function D2DRenderAdd(Source: TDirectDrawSurface; R: TRect; Transparent:Boolean; Pattern: Integer; Alpha: Byte): boolean; overload;
    function D2DRenderAdd(Image: TPictureCollectionItem; R: TRect; Pattern: Integer; Alpha:Byte): boolean; overload;
    function D2DRenderDraw(Source: TDirectDrawSurface; R: TRect; Transparent:Boolean; Pattern: Integer): boolean; overload;
    function D2DRenderDraw(Image: TPictureCollectionItem; R: TRect; Pattern: Integer): boolean; overload;
    function D2DRenderDraw(Source: TDirectDrawSurface; X, Y: Integer; Transparent:Boolean; Pattern: Integer): boolean; overload;
    function D2DRenderDraw(Image: TPictureCollectionItem; X, Y: Integer; Pattern: Integer): boolean; overload;

    function D2DRenderRotate(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle:Byte; Transparent: Boolean): boolean; overload;
    function D2DRenderRotate(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex:Integer;CenterX, CenterY:Double;Angle:Byte): boolean; overload;
    function D2DRenderRotateAdd(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte; Transparent: Boolean): boolean; overload;
    function D2DRenderRotateAdd(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex: Integer; CenterX, CenterY: Double; Angle, Alpha: Byte): boolean; overload;
    function D2DRenderRotateAlpha(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte; Transparent: Boolean): boolean; overload;
    function D2DRenderRotateAlpha(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex: Integer; CenterX, CenterY: Double; Angle, Alpha: Byte): boolean; overload;
    function D2DRenderRotateSub(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte; Transparent: Boolean): boolean; overload;
    function D2DRenderRotateSub(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex: Integer; CenterX, CenterY: Double; Angle, Alpha: Byte): boolean; overload;

    function  D2DRenderWaveXAlpha(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean; overload;
    function  D2DRenderWaveXAlpha(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean; overload;
    function D2DRenderWaveXAdd(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean; overload;
    function D2DRenderWaveXAdd(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean; overload;
    function D2DRenderWaveXSub(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean; overload;
    function D2DRenderWaveXSub(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean; overload;
    function D2DRenderWaveX(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
      amp, Len, ph: Integer):Boolean; overload;
    function D2DRenderWaveX(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
      amp, Len, ph: Integer):Boolean; overload;

    function D2DRenderFillRectAlpha(Rect: TRect; RGBColor: Integer;
      Alpha: Byte): Boolean;
    function D2DRenderFillRect(Rect: TRect; RGBColor: Integer): Boolean;
    function D2DRenderFillRectAdd(Rect: TRect; RGBColor: Integer;
      Alpha: Byte): Boolean;
    function D2DRenderFillRectSub(Rect: TRect; RGBColor: Integer;
      Alpha: Byte): Boolean;
  end;
...
//        D2D.D2DRenderDraw(Source, X ,Y, Transparent,0);
//        Exit;
//      End;
...
begin
  ...
  begin
    ...
    If AsSigned(D2D) Then
     If D2D.CanUseD2D Then
      If D2D.FDDraw.Surface = Self Then Begin
        D2D.D2DRenderDraw(Source, DestRect, Transparent,0);
        Exit;
      End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderAdd(Source, DestRect, Transparent,0,Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderAlpha(Source, DestRect, Transparent,0,Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderSub(Source, DestRect, Transparent,0,Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderRotate(Source,X,Y,Width,Height,CenterX, CenterY,Angle,Transparent);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderRotateAdd(Source,X,Y,Width,Height,CenterX, CenterY,Angle,Alpha,Transparent);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderRotateAlpha(Source,X,Y,Width,Height,CenterX, CenterY,Angle,Alpha,Transparent);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderRotateSub(Source,X,Y,Width,Height,CenterX, CenterY,Angle,Alpha,Transparent);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderWaveX(Source,X, Y, Width, Height, Transparent, amp, Len, ph);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderWaveXAdd(Source,X, Y, Width, Height, Transparent, amp, Len, ph, Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderWaveXAlpha(Source,X, Y, Width, Height, Transparent, amp, Len, ph, Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderWaveXSub(Source,X, Y, Width, Height, Transparent, amp, Len, ph, Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderFillRectAdd(DestRect, ColorToRGB(Color), 128);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderFillRectAlpha(DestRect, ColorToRGB(Color), Alpha);
      Exit;
    End;
...
begin
  ...
  If AsSigned(D2D) Then
   If D2D.CanUseD2D Then
    If D2D.FDDraw.Surface = Self Then Begin
      D2D.D2DRenderFillRectSub(DestRect, ColorToRGB(Color), 128);
      Exit;
    End;
...
//      FDXDraw.FD2D.D2DRenderDraw(Self,X,Y,PatternIndex)
//    End
//    Else
...
//    If (do3D in FDXDraw.Options) Then Begin
//      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
//      FDXDraw.FD2D.D2DRenderDraw(Self,DestRect,PatternIndex)
//    End
//    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderAdd(Self, DestRect,PatternIndex, Alpha)
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderAlpha(Self, DestRect, PatternIndex, Alpha)
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderSub(Self, DestRect,PatternIndex, Alpha)
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.FD2D.FDDraw.Options) Then Begin
      ...
      FDXDraw.FD2D.D2DRenderRotate(Self,X,Y,Width,Height,PatternIndex,CenterX, CenterY,Angle);
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderRotateAdd(Self,X,Y,Width, Height, PatternIndex, CenterX, CenterY, Angle,Alpha);
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderRotateAlpha(Self,X,Y,Width, Height, PatternIndex, CenterX, CenterY, Angle,Alpha);
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderRotateSub(Self,X,Y,Width, Height, PatternIndex, CenterX, CenterY, Angle,Alpha);
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  begin
    ...
    If (do3D in FDXDraw.Options) Then Begin
      If FDXDraw.FD2D.FDDraw.FSurface = Dest Then
      FDXDraw.FD2D.D2DRenderWaveXAlpha(Self,X, Y, Width, Height, PatternIndex, Transparent, amp, Len, ph, Alpha);
    End
    Else
    with TPictureCollectionItemPattern(FPatterns.Items[PatternIndex]) do
...
begin
  ...
  //after inheritance
  FDDraw:= DDraw;
  FVertex[0].Specular:= D3DRGB(1.0,1.0,1.0); FVertex[0].rhw:= 1.0;
  FVertex[1].Specular:= D3DRGB(1.0,1.0,1.0); FVertex[1].rhw:= 1.0;
  FVertex[2].Specular:= D3DRGB(1.0,1.0,1.0); FVertex[2].rhw:= 1.0;
  FVertex[3].Specular:= D3DRGB(1.0,1.0,1.0); FVertex[3].rhw:= 1.0;
...
begin
  Result := Length(FD2DTexture.Texture);
end;
...
Var I :Integer;
begin
  If Length(FD2DTexture.Texture) > 2048 Then Begin
  For I := Low(FD2DTexture.Texture) To High(FD2DTexture.Texture) Do
    FD2DTexture.Texture[I].D2DTexture.Free;
...
//---------------------------------------------------------------------------
Procedure TD2D.D2DEffectAdd(Alpha: Byte);
Var C: Integer;
Begin
  ...
  C := D3DRGB(Alpha*1/255, Alpha*1/255, Alpha*1/255);
  FVertex[0].Color:= C;
  FVertex[1].Color:= C;
  FVertex[2].Color:= C;
  FVertex[3].Color:= C;
...
Procedure TD2D.D2DEffectNone;
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 0);
  FVertex[0].Color:= D3DRGB(1.0, 1.0, 1.0);
  FVertex[1].Color:= D3DRGB(1.0, 1.0, 1.0);
  FVertex[2].Color:= D3DRGB(1.0, 1.0, 1.0);
  FVertex[3].Color:= D3DRGB(1.0, 1.0, 1.0);
End;

Procedure TD2D.D2DEffectCol(L1, L2, L3, L4: Integer);
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 0);
  //FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_TEXTUREMAPBLEND, Integer(D3DTBLEND_DECALALPHA));
  FVertex[0].Color:= D3DRGB(L1 / 256, L1 / 256, L1 / 256);
  FVertex[1].Color:= D3DRGB(L2 / 256, L2 / 256, L2 / 256);
  FVertex[2].Color:= D3DRGB(L3 / 256, L3 / 256, L3 / 256);
  FVertex[3].Color:= D3DRGB(L4 / 256, L4 / 256, L4 / 256);
End;

Procedure TD2D.D2DEffectAdd(L1, L2, L3, L4: Integer);
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 0);
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_SRCBLEND, Integer(D3DBLEND_ONE));
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_DESTBLEND, Integer(D3DBLEND_ONE));
...
Procedure TD2D.D2DEffectAddCol(C1, C2, C3, C4: Integer);
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 1);
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_SRCBLEND, Integer(D3DBLEND_ONE));
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_DESTBLEND, Integer(D3DBLEND_ONE));
  //:                        Red                  Green                       Blue
  FVertex[0].Color:= D3DRGB((C1 and $FF) / 255, ((C1 shr 8) and $FF) / 255, ((C1 shr 16) and $FF) / 255);
  FVertex[1].Color:= D3DRGB((C2 and $FF) / 255, ((C2 shr 8) and $FF) / 255, ((C2 shr 16) and $FF) / 255);
  FVertex[2].Color:= D3DRGB((C3 and $FF) / 255, ((C3 shr 8) and $FF) / 255, ((C3 shr 16) and $FF) / 255);
  FVertex[3].Color:= D3DRGB((C4 and $FF) / 255, ((C4 shr 8) and $FF) / 255, ((C4 shr 16) and $FF) / 255);
End;
//---------------------------------------------------------------------------

procedure TD2D.D2DEffectSolid;
Begin
  D2DEffectSolid( $FFFFFF);
End;

procedure TD2D.D2DEffectSolid(Color:Integer);
Var C:Integer;
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 0);
  ...
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_SRCBLEND, Integer(D3DBLEND_ONE));
  //:          Red                     Green                          Blue
  C := D3DRGB((Color and $FF) / 255, ((Color shr 8) and $FF) / 255, ((Color shr 16) and $FF) / 255);
  FVertex[0].Color:= C;
  FVertex[1].Color:= C;
  FVertex[2].Color:= C;
  FVertex[3].Color:= C;
...
//---------------------------------------------------------------------------
Procedure TD2D.D2DEffectBlend(Alpha:Byte);
Var C: TD3DColor;
Begin
  {Blend}
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 1);
...
Procedure TD2D.D2DEffectBlend(L1, L2, L3, L4: Integer);
Begin
  {Blend}
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 1);
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_SRCBLEND, Integer(D3DBLEND_SRCALPHA));
...
Procedure TD2D.D2DEffectMul(L1, L2, L3, L4: Integer);
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE, 1);
...
function TD2D.LoadTextures(aImage:TPictureCollectionItem):Boolean;
Var
  S: String;
Begin
  Result := True;
  Try
    ...
    if aImage.Name = '' Then
      aImage.Name := S;
    FD2DTexture.Texture[D2DMaxTextures-1].Name := aImage.Name;
    FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture := TDirect3DTexture2.Create(FDDraw, aImage.Picture.Graphic, False);
    FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Transparent := aImage.Transparent;
    FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.TransparentColor := aImage.TransparentColor;
    FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_COLORKEYENABLE, Ord(FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Transparent));
  Except
    D2DMaxTextures := D2DMaxTextures - 1;
    Result := False;
  End;
...
Begin {auto-adjust size n^2 for accelerator compatibility}
  ...
  Repeat
    Y := Y * 2
  Until DIB.Height <= Y;
  If (X = DIB.Width) and (Y = DIB.Height) Then Exit;
  tempDIB := TDIB.Create;
  Try
    tempDIB.SetSize(X,Y,DIB.BitCount);
...
function TD2D.D2DTexturedOn(Image:TPictureCollectionItem; Pattern: Integer): Boolean;
  ...
  Begin
    ...
    Try
      ...
      Try
        ...
        End;
        FD2DTexture.Texture[D2DMaxTextures-1].Name := aImage.Name;
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture := TDirect3DTexture2.Create(FDDraw, DIB, False);
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Transparent := aImage.Transparent;
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.TransparentColor := aImage.TransparentColor;
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Surface.TransparentColor := aImage.TransparentColor;
      Finally
        DIB.Free;
      End;
    Except
...
function TD2D.D2DTexturedOn(dds:TDirectDrawSurface; Transparent:Boolean): Boolean;
  ...
  Begin
    ...
    Try
      ...
      Try
        ...
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Transparent := Transparent;
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.TransparentColor := COL;
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Surface.TransparentColor := COL;
      Finally
        DIB.Free;
      End;
    Except
    ...
    begin
      ...
      If NOT (do3D in FDDraw.Options)
       ...
       or NOT (doHardware in FDDraw.Options) Then
        If FCanUseD2D Then CanUseD2D := False;
...
begin
  If NOT (do3D in FDDraw.Options) Then Exit;
  If NOT AsSigned(FDDraw.D3DDevice7) Then Exit;
  FDDraw.D3DDevice7.SetTextureStageState(0, D3DTSS_MAGFILTER, DWord(Ord(Value)+1));
  FDDraw.D3DDevice7.SetTextureStageState(0, D3DTSS_MINFILTER, DWord(Ord(Value)+1));
end;

procedure TD2D.D2DEffectSub(Alpha:Byte);
Var C:Integer;
Begin
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_ALPHABLENDENABLE,1);
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_SRCBLEND,Integer(D3DBLEND_DESTALPHA));
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_DESTBLEND,Integer(D3DBLEND_ONE));
  FDDraw.D3DDevice7.SetRenderState(D3DRENDERSTATE_TEXTUREMAPBLEND, Integer(D3DTBLEND_DECALALPHA));

  FDDraw.D3DDevice7.SetTextureStageState(0,D3DTSS_ALPHAOP,Integer(D3DTOP_SUBTRACT));
  C := RGBA_MAKE($FF,$FF,$FF,Alpha);
  FVertex[0].Color:= C;
  FVertex[1].Color:= C;
  FVertex[2].Color:= C;
...
Begin
  FVertex[0].sx:= R.Left;
  FVertex[0].sy:= R.Top;
  FVertex[1].sx:= R.Right;
  FVertex[1].sy:= R.Top;
  FVertex[2].sx:= R.Left;
  FVertex[2].sy:= R.Bottom;
  FVertex[3].sx:= R.Right;
  FVertex[3].sy:= R.Bottom;
End;

{Final public routines}

function TD2D.D2DRenderAlpha(Source: TDirectDrawSurface; R: TRect; Transparent:Boolean; Pattern: Integer; Alpha: Byte):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Blend}
  D2DEffectBlend(Alpha);
  Result := D2DTexturedOn(Source, Transparent);
  D2DMeshMapToRect(R);
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
end;

function TD2D.D2DRenderAlpha(Image: TPictureCollectionItem; R: TRect;{Xpos, Ypos,} Pattern: Integer; Alpha: Byte):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Blend}
  D2DEffectBlend(Alpha);
  Result := D2DTexturedOn(Image,Pattern);
  D2DMeshMapToRect(R);
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
end;

function TD2D.D2DRenderSub(Source: TDirectDrawSurface; R: TRect; Transparent:Boolean; Pattern: Integer; Alpha: Byte):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Sub}
  D2DEffectMul(Alpha);//D2DEffectSub(Alpha);
  Result := D2DTexturedOn(Source, Transparent);
  D2DMeshMapToRect(R);
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
end;

function TD2D.D2DRenderSub(Image: TPictureCollectionItem; R: TRect; Pattern: Integer; Alpha:Byte):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Sub}
  D2DEffectMul(Alpha);//D2DEffectSub(Alpha);
...
function TD2D.D2DRenderAdd(Source: TDirectDrawSurface; R: TRect; Transparent:Boolean; Pattern: Integer; Alpha: Byte):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Add}
  D2DEffectAdd(Alpha);
...
function TD2D.D2DRenderAdd(Image: TPictureCollectionItem; R: TRect; Pattern: Integer; Alpha:Byte):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Add}
  D2DEffectAdd(Alpha);
...
function TD2D.D2DRenderDraw(Image: TPictureCollectionItem; R: TRect; Pattern: Integer):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Draw}
  D2DEffectSolid;
...
function TD2D.D2DRenderDraw(Image: TPictureCollectionItem; X, Y: Integer; Pattern: Integer):Boolean;
...
begin
  ...
  D2DMeshMapToRect(Bounds(X,Y,PWidth,PHeight));
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
end;

function TD2D.D2DRenderDraw(Source: TDirectDrawSurface; R: TRect; Transparent: Boolean; Pattern: Integer):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Draw}
  D2DEffectSolid;
...
function TD2D.D2DRenderDraw(Source: TDirectDrawSurface; X, Y: Integer; Transparent: Boolean; Pattern: Integer):Boolean;
begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Draw}
  D2DEffectSolid;
  Result := D2DTexturedOn(Source, Transparent);
  D2DMeshMapToRect(Bounds(X,Y,Source.Width,Source.Height));
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
end;

{--}

procedure TD2D.D2DMeshMapToRotate(X,Y, W,H: Integer; Px,Py:Double; Angle: Byte);
  procedure Rotate(Var X,Y:Integer; Xo,Yo :Integer;  iRotation:Extended);
  Var   D     :Extended;
        Angle :Extended;
  Begin
    X := X - Xo;
    ...
    D   := Sqrt(X*X + Y*Y);
    Angle := 0;
    if (x=0) and (x=y) then Angle:=0 { obì nula -> úhel nula }
    else
    begin { jinak alespoò jedna nenulová }
      if x=0 then
        if y<0 then Angle:=PI * 1.5
        else Angle:=PI/2;
      if y=0 then
        if x<0 then Angle:=PI
        else Angle:=0;
      if (x<>0) and (y<>0) then { obì jsou nenulové }
      begin
        {POZOR na spravny argument v ARCTAN() !!!}
        if x<0 then
          if y<0 then
            Angle:=PI+ArcTan(Abs(y/x))
          else
            Angle:=PI/2+ArcTan(Abs(x/y))
        Else
        if x>0 then
          if y<0 then
            Angle:=1.5*PI+ArcTan(Abs(x/y))
          else
            Angle:=ArcTan(Abs(y/x));
      end;
    end;
    { Rotation about iRot }
    Angle := Angle + iRotation; {all radians}
    { Compute New X,Y }
    X := Round(Xo+D*Cos(Angle));
    Y := Round(Yo+D*Sin(Angle));
  End;
  Function getSO(XY,WH: Integer;B:Boolean):Integer;
  Begin
    If B Then Result := XY + WH Else Result := X - WH;
  End;
Const
  PI256 = 2*PI/256;
Var
  RAng: Double;
  X1,Y1,X2,Y2,X3,Y3,X4,Y4, Wp,Hp:Integer;
Begin
  {recalc angle to radians}
  RAng:= Angle * PI256;
  {where rotate in picture}
  Wp := Abs(Round((W * Px)));
  Hp := Abs(Round((H * Py)));
  {recalc of mesh}
  X1 := X      - Wp;
  ...
  X4 := X + W  - Wp;
  Y4 := Y + H  - Hp;
  {a simple point rotate}
  Rotate(X1,Y1,X,Y,RAng);
  Rotate(X2,Y2,X,Y,RAng);
  Rotate(X3,Y3,X,Y,RAng);
  Rotate(X4,Y4,X,Y,RAng);
  {set up vertexes}
  FVertex[0].sx:= X1;
  FVertex[0].sy:= Y1;
  FVertex[1].sx:= X2;
...
function TD2D.D2DRenderRotate(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex:Integer;CenterX, CenterY:Double;Angle:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectAdd($FF, $FF, $FF, $FF);
  {load textures and map it}
  Result := D2DTexturedOn(Image,PatternIndex);
  {do rotate mesh}
  D2DMeshMapToRotate(RotX,RotY, PictWidth,PictHeight,CenterX,CenterY,Angle);
  {render it}
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
End;

function TD2D.D2DRenderRotate(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle:Byte; Transparent: Boolean):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectAdd($FF, $FF, $FF, $FF);
  {load textures and map it}
  Result := D2DTexturedOn(Image,Transparent);
  {do rotate mesh}
  D2DMeshMapToRotate(RotX,RotY, PictWidth,PictHeight,CenterX,CenterY,Angle);
  {render it}
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
...
function TD2D.D2DRenderRotateAdd(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectAdd(Alpha);
...
function TD2D.D2DRenderRotateAdd(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte; Transparent: Boolean):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectAdd(Alpha);
...
function TD2D.D2DRenderRotateSub(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectSub(Alpha);
...
function TD2D.D2DRenderRotateSub(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte; Transparent: Boolean):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectSub(Alpha);
...
function TD2D.D2DRenderRotateAlpha(Image: TPictureCollectionItem; RotX, RotY, PictWidth, PictHeight, PatternIndex:Integer;CenterX, CenterY:Double;Angle, Alpha:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectBlend(Alpha);
...
function TD2D.D2DRenderRotateAlpha(Image: TDirectDrawSurface; RotX, RotY, PictWidth, PictHeight:Integer;CenterX, CenterY:Double;Angle,Alpha:Byte; Transparent: Boolean):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectBlend(Alpha);
...
{------------------------------------------------------------------------------}
{created 31.1.2005}
function TD2D.D2DMeshMapToWave(dds:TDirectDrawSurface; Transparent:Boolean; X, Y,
 Width, Height: Integer; amp, Len, ph, Alpha: Integer; effect:Byte):Boolean;
...
Var
  SVertex: Array of TD3DTLVERTEX;
  I,maxVertex,maxPix,VStepVx,TexNo:Integer;
  VStep, VStepTo, D, Z:Extended;
Begin
  Result := False;
  //nastavuje se tolik vertexu, kolik je potreba
  //speculative set up of rows for better look
  maxVertex := 2* Trunc(Height / Len * 8);
  If (maxVertex mod 2) > 0 Then {top to limits}
    Inc(maxVertex,2);
  If (maxVertex div 2) > Height Then {correct to height}
    maxVertex := 2*Height;
  //zde uschovano maximum [0..1] po adjustaci
  //textury, ktera nemela nektery rozmer 2^n
  //FD2DTexture.Texture[I].FloatX2;
  //FD2DTexture.Texture[I].FloatY2;
  //napr. pokud byl rozmer 0.7 pak je nutno prepocitat
  //tento interval [0..0.7] na height
  if NOT D2DTexturedOn(dds,Transparent,TexNo) Then Exit;

  //pocet pixlu mezi plo
  Repeat
  ...
  VStep := FD2DTexture.Texture[TexNo].FloatY2 / (maxVertex div 2);
  ...
  {vlastni nastaveni vertexu v pasu}
  For I := 0 To maxVertex - 1 Do Begin
    ...
    Case (I+1) mod 2 Of //triangle driver
     1: Begin
      ...
      0:SVertex[I].color := RGBA_MAKE($FF,$FF,$FF,$FF);
      1:SVertex[I].color := RGBA_MAKE($FF,$FF,$FF,Alpha);
      2:SVertex[I].color := D3DRGB(Alpha*1/255, Alpha*1/255, Alpha*1/255);
      3:SVertex[I].color := D3DRGB(Alpha / 255, Alpha / 255, Alpha / 255);
      End;
      If I <> 0 Then Inc(VStepVx,maxPix);
      SVertex[I].sx := X+Trunc(amp * Sin((Y+VStepVx)/Z+D)); //levy
      SVertex[I].sy := Y+VStepVx;
      SVertex[I].tu := FD2DTexture.Texture[TexNo].FloatX1;
      if I <> 0 Then VStepTo := VStepTo + VStep;
      SVertex[I].tv := VStepTo;
      End;
     0: Begin
      Case Effect of
      1:SVertex[I].color := RGBA_MAKE($FF,$FF,$FF,Alpha);
      ...
      SVertex[I].sy := Y+VStepVx;
      SVertex[I].tu := FD2DTexture.Texture[TexNo].FloatX2;
      SVertex[I].tv := VStepTo;
      End;
    End;{case}
  End;
...
function TD2D.D2DRenderWaveXAlpha(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
...
Begin
  ...
  Result := D2DMeshMapToWave(Image.PatternSurfaces[PatternIndex],transparent, X, Y, Width, Height, amp, Len, ph, Alpha, 1{alpha effect});
End;

function TD2D.D2DRenderWaveXAlpha(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
      amp, Len, ph, Alpha: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectBlend(Alpha);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Source,transparent, X, Y, Width, Height, amp, Len, ph, Alpha, 1{alpha effect});
End;

function TD2D.D2DRenderWaveXAdd(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
  amp, Len, ph, Alpha: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectAdd(Alpha);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Image.PatternSurfaces[PatternIndex],transparent, X, Y, Width, Height, amp, Len, ph, Alpha, 2{add effect});
End;

function TD2D.D2DRenderWaveXAdd(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
  amp, Len, ph, Alpha: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectAdd(Alpha);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Source,transparent, X, Y, Width, Height, amp, Len, ph, Alpha, 2{add effect});
End;

function TD2D.D2DRenderWaveXSub(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
  amp, Len, ph, Alpha: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectMul(Alpha);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Image.PatternSurfaces[PatternIndex],transparent, X, Y, Width, Height, amp, Len, ph, Alpha, 3{sub effect});
End;

function TD2D.D2DRenderWaveXSub(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
  amp, Len, ph, Alpha: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectMul(Alpha);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Source,transparent, X, Y, Width, Height, amp, Len, ph, Alpha, 3{sub effect});
End;

function TD2D.D2DRenderWaveX(Image: TPictureCollectionItem;X, Y, Width, Height, PatternIndex: Integer; transparent: Boolean;
  amp, Len, ph: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectBlend($FF);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Image.PatternSurfaces[PatternIndex],transparent, X, Y, Width, Height, amp, Len, ph, $FF, 0{no effect});
End;

function TD2D.D2DRenderWaveX(Source: TDirectDrawSurface;X, Y, Width, Height: Integer; transparent: Boolean;
  amp, Len, ph: Integer):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {set of effect}
  D2DEffectBlend($FF);
  {load textures and map, do make wave mesh and render it}
  Result := D2DMeshMapToWave(Source,transparent, X, Y, Width, Height, amp, Len, ph, $FF, 0{no effect});
End;
    ...
    Try
      ...
      Try
        ...
        With FD2DTexture.Texture[D2DMaxTextures-1] Do Begin
          FloatX1 := 0; FloatY1 := 0; FloatX2 := 1; FloatY2 := 1;
        End;
        FD2DTexture.Texture[D2DMaxTextures-1].Name := S;
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture := TDirect3DTexture2.Create(FDDraw, DIB, False);
        FD2DTexture.Texture[D2DMaxTextures-1].D2DTexture.Transparent := False; //cannot be transparent
      Finally
        DIB.Free;
      End;
    Except
...
begin
  ...
  If NOT CanFindTexture(Color) Then {when no texture in list try load it}
    If NOT LoadTextures(Color) Then Exit; {on error occurr out}
...
function TD2D.D2DRenderFillRectAlpha(Rect:TRect; RGBColor:LongInt; Alpha:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Blend}
  D2DEffectBlend(Alpha);
  Result := D2DTexturedOnRect(Rect,RGBColor);
  D2DMeshMapToRect(Rect);
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
End;

function TD2D.D2DRenderFillRectAdd(Rect:TRect; RGBColor:LongInt; Alpha:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Add}
  D2DEffectAdd(Alpha);
...
function TD2D.D2DRenderFillRectSub(Rect:TRect; RGBColor:LongInt; Alpha:Byte):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {Sub}
  D2DEffectMul(Alpha);
...
function TD2D.D2DRenderFillRect(Rect:TRect; RGBColor:LongInt):Boolean;
Begin
  Result := False; If NOT CanUseD2D Then Exit;
  {nothing}
  D2DEffectBlend($FF); //why no?
  Result := D2DTexturedOnRect(Rect,RGBColor);
  D2DMeshMapToRect(Rect);
  FDDraw.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLESTRIP, D3DFVF_TLVERTEX, FVertex, 4, D3DDP_WAIT);
End;
